...
Route::get('phan-tich/{folder?}/{page?}', [DashboardController::class, 'phanTich'])->name('phan-tich');
Route::post('phan-tich/{folder?}/{page?}', [DashboardController::class, 'phanTich'])->name('phan-tich');
