...
# python crack_predict.py --model output/Model_new_5.h5 --image_path crack_images
...
while len(filelist) > 0:
	...
	scan_matrix(0, 0, image)
	scan_matrix(0, 50, image)
	scan_matrix(50, 0, image)
	scan_matrix(50, 50, image)
